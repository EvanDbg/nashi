...
//    if([_dataPath isEqualToString:@"tessdata"]){
//        dataPath = [documentPath stringByAppendingPathComponent:_dataPath];
//    }
...
//    if([_dataPath isEqualToString:@"tessdata"]){
//        path = [[documentPath stringByAppendingString:@"/"] UTF8String];
//    }
